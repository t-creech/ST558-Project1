...
print(single_year_data(num_vars = c("JWAP", "JWDP","AGEP"),cat_vars=c("FER", "HHL", "HISPEED", "JWTRNS", "SCH", "SCHL", "SEX")))
  pumps_Data<-print(single_year_data(num_vars = c("JWAP", "JWDP","AGEP"),cat_vars=c("FER", "HHL", "HISPEED", "JWTRNS", "SCH", "SCHL", "SEX")))
